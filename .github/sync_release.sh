...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-IronHorse_MiSTer.git"
CORE_NAME=(Arcade-IronHorse)
...
UPSTREAM_CORE_NAME=(Arcade-IronHorse)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-IronHorse.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-IronHorse.rbf)
